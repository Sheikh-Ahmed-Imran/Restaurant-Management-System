  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className="w-full h-[52px] text-base text-[#ADAEBC] border bg-white px-4 rounded-lg border-2"
      />
      <div className="absolute -translate-y-2/4 right-4 top-2/4">
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
